        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link mt-1 {{ $title === 'Film' ? 'active' : '' }}"
                            href="{{ route('movie.index') }}">Movie</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mt-1 {{ $title === 'Now Playing' ? 'active' : '' }}"
                            href="{{ route('movie.index') }}">Now Playing</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mt-1 {{ $title === 'Coming Soon' ? 'active' : '' }}"
                            href="{{ route('movie.index') }}">Coming Soon</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mt-1 {{ $title === 'About' ? 'active' : '' }}" href="/about">About</a>
                    </li>
                    @if (Auth::guest())
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row row-cols-2 row-cols-md-2 g-3 py-5">
                <div class="col-md-6 col-lg-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2">
                            <a href="index.html" class="nav-link1 p-0 text-muted">Movie</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a href="Blog.html" class="nav-link1 p-0 text-muted">Now Playing</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a href="PetCare.html" class="nav-link1 p-0 text-muted">Coming Soon</a>
                        </li>
                        <li class="nav-item mb-2">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2">
                            <a href="#" class="nav-link1 p-0 text-muted">Coming Soon</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a href="#" class="nav-link1 p-0 text-muted">Now Playing</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a href="#" class="nav-link1 p-0 text-muted">Popular</a>
                        </li>
                    </ul>
                </div>
